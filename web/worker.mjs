...
try{
 ...
 await recoverNames(source,{provider:new CompatibleProvider({baseUrl:endpoints[provider],apiKey,model,timeoutMs:30000,maxResponseBytes:1048576}),...validateOptions(workerData.options),onEvent:event=>parentPort.postMessage(event)});
