...
export async function createHtmlReporter(directory:string){
 ...
 const write=serialWriter(async line=>{
  ...
  if(event.type==='plan')estimate=event.estimate;
